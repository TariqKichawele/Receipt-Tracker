    ...
    const handleDeleteReceipt = async () => {
        ...
        if (window.confirm("Are you sure you want to delete this receipt? This action cannot be undone.")) {
            try {
                ...
                alert("Failed to delete the receipt. Please try again later.");
                setIsDeleting(false);
            }
        }
    }
        ...
        return (
            <div className='container mx-auto py-10 px-4'>
                <div className='max-w-2xl mx-auto text-center'>
                    ...
                    <p>
                        The receipt you&apos;re looking for does not exist or has been deleted.
                    </p>
                ...
                <div className='p-6'>
                                        ...
                                        <div className='mt-6 bg-gray-100 p-6 rounded-lg border border-gray-200 shadow-sm'>
                                            ...
                                            <div className='bg-white bg-opacity-50 rounded-lg p-4 border border-gray-200 flex flex-col items-center justify-center'>
                                                <Link href={"/manage-plan"} className='text-center py-4'>
                                                    ...
                                                    <button className='mt-2 px-4 py-1.5 text-white bg-blue-500 rounded hover:bg-blue-600 inline-block'>
                    ...
                    <div className='mt-8 border-t pt-6'>
                        ...
                        <div className='flex flex-wrap gap-3'>
                            ...
                            <button
                                className={`px-4 py-2 bg-red-500 text-white rounded text-sm ${isDeleting ? "bg-gray-100 border-gray-200 text-gray-400 cursor-not-allowed" : "bg-red-50 border border-red-200 text-red-600 hover:bg-red-100"}`}
